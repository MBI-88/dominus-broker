...
import (
	...
	"github.com/PR0C0D3-MBI/dominus-proto-definition/src/dominus"
...
func (r *receiveGrpc) Recv() (*dominus.RequestMessage, error) {
	return &dominus.RequestMessage{
		Subscribers: r.subs,
		Payload:     r.payload,
	}, nil
}
...
func (r *receiveGrpc) SendAndClose(*dominus.Response) error {
	return nil
}
...
func (r *receiveGrpc) Send(d *dominus.ResponseMessage) error {
