...
func NewLogs(mode, url string, devMode bool) adapters.Logs {
...
func (l *logs) WriteLog(ctx context.Context, level, op, dsc string) {
...
func (l *logs) CheckID(ctx context.Context) context.Context {
...
func (l *logs) clientLog(level string, message []byte) {
